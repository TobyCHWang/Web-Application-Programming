 ...
 * @author toby
 */
@WebServlet(name = "registerPageController", urlPatterns = {"/registerPageController"})
public class registerPageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String passwordString=request.getParameter("passwordRegister");
        
     
                 if (dbOps.addUser(usernameString,passwordString)) {
                     request.setAttribute("message", "User "+"'"+usernameString+"'"+" created successfully");

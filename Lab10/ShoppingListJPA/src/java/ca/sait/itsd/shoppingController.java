    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String cartString=request.getParameter("cart");
           ...
           if (deleteString!=null) {
                   ...
                   Long itemLong=Long.parseLong(deleteItem);
                 if (dbOps.deleteItem(itemLong)) {
             ...
             if (cartString!=null) {
                   String changeCart=request.getParameter("itemChange");
                    Long itemChange=Long.parseLong( changeCart);
                    Boolean cartStatus=Boolean.parseBoolean(cartString);
                  if (cartString.equals("true")) {
                       if (dbOps.updateCart(itemChange,cartStatus)) {

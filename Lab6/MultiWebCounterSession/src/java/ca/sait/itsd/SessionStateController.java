...
public class SessionStateController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String applicationString=request.getParameter("incrementAppication");
        int count=0;
        int count2=0;
        ...
        if (application.getAttribute("usercount")!=null) {
                count2=(Integer)application.getAttribute("usercount");
            }
            count2++;
        }else if (reset!=null) {
          ...
          application.setAttribute("usercount", count2);
         request.getRequestDispatcher("WEB-INF/WebCounter.jsp").forward(request, response);
